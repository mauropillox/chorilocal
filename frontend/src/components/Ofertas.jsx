  ...
  return (
    <div className="p-4" style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="info-banner" style={{ 
        ...
        <h3 style={{ margin: 0, fontSize: '0.95rem', fontWeight: 600, color: '#92400e' }}>💡 ¿Qué es esto?</h3>
        <p style={{ margin: '0.5rem 0 0', fontSize: '0.85rem', color: '#78350f', lineHeight: 1.5 }}>
          Las <strong>ofertas</strong> te permiten crear promociones temporales o descuentos especiales. 
          Puedes asignarlas a productos específicos o aplicarlas de forma general. 
          Las ofertas activas aparecen marcadas con un contador en el menú de navegación.
        </p>
      </div>
      ...
      <div className="card" style={{ background: 'var(--color-bg)', padding: '24px', borderRadius: '16px', border: '1px solid var(--color-border)' }}>
        ...
        {ofertas.length === 0 ? (
          <div className="text-center py-12" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <p>No hay ofertas registradas. Crea una para comenzar.</p>
          </div>
        ) : (
            ...
            {ofertas.map(oferta => {
              ...
              return (
                <div key={oferta.id} 
                  ...
                  {/* Header con gradiente Casa de Congelados */}
                  <div style={{ 
